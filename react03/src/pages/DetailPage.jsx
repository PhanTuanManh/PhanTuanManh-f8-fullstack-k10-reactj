...
const DetailPage = () => {
  ...
  return (
    <section class="product mp-fullpage-section-pad flex lg:flex-row flex-col xl:gap-[20px] lg:gap-[10px] gap-[20px] w-full">
      <div class="motion-preset-slide-right motion-delay-[300ms] list-img max-w-[80px] flex lg:flex-col flex-row gap-[10px] lg:order-1 order-2">
        {product.images.map((image, index) => (
          <img key={index} src={image} alt="" class="w-full object-cover" />
        ))}
      </div>
      <div
        id="detail-img"
